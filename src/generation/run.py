...
def main(args):
    ...
    # for _idx, example in enumerate(new_examples):
    #     # if example['type'] == 'next' and example['activity_name'] == 'Spiced Hot Chocolate':
    #         # print(example['generation']['prompt'])
    #     if example['activity_name'] == 'Spiced Hot Chocolate':
    #         print(_idx)
    #         sys.exit('stop')
    # sys.exit('stopp')
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dirpath_recipe_image", type=Path, help="dirpath to recipe images", default=None
    )
    parser.add_argument(
        "--dirpath_output",
        type=Path,
