...
def annotate():
    ...
    foldername = Path(os.getenv("FOLDERNAME"))
    filepath_video_high = foldername / f"trimmed-videos/2160p/{example['example_id']}.mp4"
    filepath_video_low = foldername / f"trimmed-videos/360p/{example['example_id']}.mp4"
    ...
    data = {
        ...
        "graph": f"{foldername}/instruction-images/{example['example_id']}.png",
